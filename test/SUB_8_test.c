...
int main()
{
    ...
    if (CU_add_test(
            test_suite,
            "8 bit SUB Instructions | SUB_A_A adds value in register A plus the carry flag to itself",
            test_SUB_A_A
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit SUB Instructions | SUB_A_B adds B register value and carry flag to A register value",
            test_SUB_A_B
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit SUB Instructions | SUB_A_C adds C register value and carry flag to A register value",
            test_SUB_A_C
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit SUB Instructions | SUB_A_D adds D register value and carry flag to A register value",
            test_SUB_A_D
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit SUB Instructions | SUB_A_E adds E register value and carry flag to A register value",
            test_SUB_A_E
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit SUB Instructions | SUB_A_H adds H register value and carry flag to A register value",
            test_SUB_A_H
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit SUB Instructions | SUB_A_L adds L register value and carry flag to A register value",
            test_SUB_A_L
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit ALU | SUB_A_n adds immediate value and carry flag to A register value",
            test_SUB_A_n
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit ALU | SUB_A_HL adds value pointed to from HL register and carry flag to A register value",
            test_SUB_A_HL
        ) == NULL) {
