...
int main()
{
    ...
    if (CU_add_test(
            test_suite,
            "8 bit CP Instructions | CP_A_A leaves A as is",
            test_CP_A_A
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit CP Instructions | CP_A_B sets A to bitwise or with B",
            test_CP_A_B
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit CP Instructions | CP_A_C sets A to bitwise or with C",
            test_CP_A_C
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit CP Instructions | CP_A_D sets A to bitwise or with D",
            test_CP_A_D
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit CP Instructions | CP_A_E sets A to bitwise or with E",
            test_CP_A_E
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit CP Instructions | CP_A_H sets A to bitwise or with H",
            test_CP_A_H
        ) == NULL ||
        CU_add_test(
            test_suite,
            "8 bit CP Instructions | CP_A_L sets A to bitwise or with L",
            test_CP_A_L
        // ) == NULL ||
        // CU_add_test(
        //     test_suite,
        //     "8 bit CP Instructions | CP_A_n sets A to bitwise or with immediate value",
        //     test_CP_A_n
        // ) == NULL ||
        // CU_add_test(
        //     test_suite,
        //     "8 bit CP Instructions | CP_A_HL sets A to bitwise or with byte in address at HL",
        //     test_CP_A_HL
        ) == NULL) {
