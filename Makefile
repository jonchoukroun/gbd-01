...
$(TEST_BUILD_DIR)ADC_8_test.o: $(TEST_DIR)ADC_8_test.c
	$(INSTRUCTIONS_TEST_COMPILE_OPTS)

$(TEST_BUILD_DIR)SUB_8_test.o: $(TEST_DIR)SUB_8_test.c
	$(INSTRUCTIONS_TEST_COMPILE_OPTS)
...
$(TEST_BUILD_DIR)INC_test.o: $(TEST_DIR)INC_test.c
	$(INSTRUCTIONS_TEST_COMPILE_OPTS)
...
$(TEST_BUILD_DIR)shift_test.o: $(TEST_DIR)shift_test.c
	$(INSTRUCTIONS_TEST_COMPILE_OPTS)
