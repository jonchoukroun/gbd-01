...
/* c */     &RETC,   &POP_rr,      &JPC,      &JP,   &CALLC, &PUSH_rr,    &ADD_n,   &UNDEF,    &RETC,      &RET,      &JPC,   &UNDEF,   &CALLC,    &CALL,    &ADC_n,   &UNDEF,
/* d */     &RETC,   &POP_rr,      &JPC,   &UNDEF,   &CALLC, &PUSH_rr,    &SUB_n,   &UNDEF,    &RETC,     &RETI,      &JPC,   &UNDEF,   &CALLC,   &UNDEF,    &SBC_n,   &UNDEF,
